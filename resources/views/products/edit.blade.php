                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" name="category_id">
                        ...
                        <option value="{{ $category->id }}"
                            {{ $category->id == $product->category->id ? 'selected' : '' }}> {{ $category->name }}
                        </option>
                        @endforeach
                    </select>
                    @error('category_id')
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <el-upload name="image"
                        url-image="{{ ($product->image == 'default.png') ? asset('libs/uploads/'.$product->image) : asset('storage/'.$product->image) }}"
