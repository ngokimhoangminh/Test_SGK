        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype='multipart/form-data'>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input-form name="price" value="{{ old('price') }}" data-type="currency"></input-form>
                    @error('price')
                    <message-toast class-name="alert alert-danger mt-1" message="{{ $message  }}"></message-toast>
                    @enderror
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input-form name="discount" value="{{ old('discount') }}" data-type="currency"></input-form>
                    @error('discount')
                    <message-toast class-name="alert alert-danger mt-1" message="{{ $message  }}"></message-toast>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <el-upload name="image" width="200px" height="200px"></el-upload>
                    @error('image')
                    <message-toast class-name="alert alert-danger mt-1" message="{{ $message  }}"></message-toast>
                    @enderror
                </div>
